...
float t1, bbb, bb, f_inicial, o, f, a, n2=1, presion_final, volumen_final, temperatura_final, x1, v, a1, t2, x2, x3, m, b1, k, resultado, resultado2, o1, max=450, min=100, f_angular, c1, d1, e1, f1;
  ...
  //--------------etapa 4 de la simulacion------------------
    ...
    if (caso=="sistema no amortiguado") {
      ...
      if (contador==60 && continuar==false) {
        ...
        pos1[cont]=amplitud1[cont]*cos(f*cont-bbb); 
